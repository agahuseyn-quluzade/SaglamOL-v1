...
import az.saglamol.policy.repository.OutboxEventRepository;
...
@Configuration
@EnableScheduling
public class PolicyOutboxConfig {

    @Bean
    OutboxEventService<OutboxEvent> policyOutboxEventService(
    ...
    OutboxPublisherScheduler<OutboxEvent> policyOutboxPublisherScheduler(
            OutboxEventRepository repository,
