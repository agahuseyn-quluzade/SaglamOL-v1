package az.saglamol.iam.config;
...
import az.saglamol.iam.repository.OutboxEventRepository;
...
@Configuration
@EnableScheduling
public class IamOutboxConfig {

    @Bean
    OutboxEventService<OutboxEvent> iamOutboxEventService(
    ...
    OutboxPublisherScheduler<OutboxEvent> iamOutboxPublisherScheduler(
            OutboxEventRepository repository,
            EventEnvelopeFactory envelopeFactory,
            KafkaPublisher kafkaPublisher,
            OutboxProperties properties
    ) {
        return new OutboxPublisherScheduler<>(repository, envelopeFactory, kafkaPublisher, properties, "iam-service");
    }
}
